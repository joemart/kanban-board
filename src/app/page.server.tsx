...
export default function Kanban() {
  ...
  return (
    <SidebarProvider className=" h-full min-h-auto flex gap-10" >
        ...
        {auth.isAuthenticated ? <BoardContext.Provider value={{handleSelectBoard, board, addOneColumn, columns, editColumn, addOneCard, removeOneCard, editOneCard}}>
        <Sidebar />
        ...
        </BoardContext.Provider> : <section className="flex justify-center items-center w-full text-8xl">Kanban Board</section>}
      </SidebarProvider> 
